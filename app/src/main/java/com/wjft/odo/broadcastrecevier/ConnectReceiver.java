package com.wjft.odo.broadcastrecevier;
...
public class ConnectReceiver extends BroadcastReceiver {
        ...
        if (action == "android.net.conn.CONNECTIVITY_CHANGE") {
            ...
            if (activeNetworkInfo != null && activeNetworkInfo.isAvailable()) {
                if (activeNetworkInfo != null && activeNetworkInfo.isConnected()) {
                    if ( activeNetworkInfo.getType() == ConnectivityManager.TYPE_WIFI) {//wifi

                    } else if ( activeNetworkInfo.getSubtype() == TelephonyManager.NETWORK_TYPE_LTE) {//4g

                    } else {//其他网络
                        getNetWorkType(activeNetworkInfo);
                    }
                }
            }
     ...
     * </ul>
     */
    public int getNetWorkType(NetworkInfo i) {
